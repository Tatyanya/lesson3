...
class Header{
	constructor (){
        ...
        this.NewsDropdownItems = this.NewsButton.$$(('.mega-sub-menu li'));

        this.NewsDropdown = this.NewsButton.$('.mega-sub-menu');
        this.BreakingNewsButton = this.NewsDropdown.$('li:nth-child(1)');

        this.LocationsButton = this.AboutButton.$('.mega-sub-menu li:nth-child(3)');
